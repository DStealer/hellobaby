 ...
 */
public class MemMonitorPojo {
    /**
     * 解析映射
     */
    public static final RSHandler<MemMonitorPojo> HANDLER = new RSHandler<MemMonitorPojo>() {
        @Override
        public MemMonitorPojo parseFrom(ResultSet rs) throws SQLException {
            MemMonitorPojo pojo = new MemMonitorPojo();
